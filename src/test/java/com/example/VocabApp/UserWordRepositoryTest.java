...
public class UserWordRepositoryTest {
    ...
    void testFindByUserIdAndWordId() {
        ...
        Optional<UserWord> found = userWordRepository.findByUserIdAndWordId(user.getUserId(), word.getWordId());
    ...
    void testFindByUserIdOrderByLastReviewedDesc() {
        ...
        List<UserWord> ordered = userWordRepository.findByUserIdOrderByLastReviewedDesc(user.getUserId());
